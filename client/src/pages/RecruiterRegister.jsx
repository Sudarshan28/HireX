    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-white border-r border-gray-200 relative overflow-hidden flex-col justify-center items-center p-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h2 className="text-3xl font-display font-bold mb-4 text-gray-900">HireX for Recruiters</h2>
          <p className="text-gray-800 font-body text-base font-medium">
            Configure job metrics, score applicants with AI embeddings, and streamline your recruitment pipeline.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 overflow-y-auto">
        <div className="w-full max-w-md bg-white border border-gray-200 shadow-sm rounded-xl p-8 my-8">
          <div className="mb-6 text-center lg:text-left">
            <h1 className="text-2xl font-display font-bold mb-2 text-gray-900">INITIALIZE RECRUITER ACCOUNT</h1>
            <p className="text-gray-800 font-body text-sm font-medium">Register your company to begin hiring</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-mono text-gray-900 font-bold uppercase mb-1">Company Name</label>
              <input
                type="text"
                required
                value={company}
          ...
          <p className="mt-6 text-center text-sm text-gray-800 font-body font-medium">
            ...
            <Link to="/recruiter/login" className="font-bold text-gray-950 hover:underline">
              Sign in
            </Link>
          </p>
        </div>
